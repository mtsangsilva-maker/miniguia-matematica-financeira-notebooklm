...
Estou me preparando para o concurso do Banco do Brasil (escriturário/agente comercial) 
e escolhi Matemática Financeira como tema deste caderno por ser uma das áreas onde 
sinto mais dificuldade, especialmente em:
...
Para este caderno temático, selecionei 4 fontes abertas, priorizando material específico 
para o concurso do Banco do Brasil e para a banca CESGRANRIO:
...
2. **Matemática Financeira CESGRANRIO - Questões Comentadas (Prof. Daniela Arboite)**  
   Coletânea de questões comentadas de matemática financeira cobradas pela banca 
   CESGRANRIO em concursos bancários (BB, Banrisul, BASA, CEF).  
...
4. **Vídeo: "Concurso Banco do Brasil 2026 | Matemática Financeira: Conceitos Gerais"**  
   Aula em vídeo (canal Nova Concursos) cobrindo juros simples, juros compostos, 
   capital/taxa/tempo, montante, desconto simples, taxa nominal e efetiva, e sistemas 
   de capitalização — com foco nos erros mais comuns dos candidatos.  
